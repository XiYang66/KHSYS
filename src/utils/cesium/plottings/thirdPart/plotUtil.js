...
P.PlotUtils = {};
P.PlotUtils.distance = (t, o) => {
  return Math.sqrt(Math.pow(t[0] - o[0], 2) + Math.pow(t[1] - o[1], 2));
};
P.PlotUtils.wholeDistance = (t) => {
  let distance = 0;
...
P.PlotUtils.getIntersectPoint = (t, o, e, r) => {
  let g, n, i, s;
  if (t[1] == o[1]) {
    n = (r[0] - e[0]) / (r[1] - e[1]);
    g = n * (t[1] - e[1]) + e[0];
...
P.PlotUtils.getAngleOfThreePoints = (t, o, e) => {
  let r = P.PlotUtils.getAzimuth(o, t) - P.PlotUtils.getAzimuth(o, e);
  return 0 > r ? r + P.Constants.TWO_PI : r;
};
P.PlotUtils.isClockWise = (t, o, e) => {
  return (e[1] - t[1]) * (o[0] - t[0]) > (o[1] - t[1]) * (e[0] - t[0]);
};
P.PlotUtils.getPointOnLine = (t, o, e) => {
  let r = o[0] + t * (e[0] - o[0]),
    n = o[1] + t * (e[1] - o[1]);
  return [r, n];
};
P.PlotUtils.getCubicValue = (t, o, e, r, n) => {
...
P.PlotUtils.getThirdPoint = (t, o, e, r, n) => {
...
P.PlotUtils.getArcPoints = (t, o, e, r) => {
  let n,
    g,
    i = [],
    s = r - e;
...
P.PlotUtils.getBisectorNormals = (t, o, e, r) => {
...
P.PlotUtils.getCurvePoints = (t, o) => {
...
P.PlotUtils.getLeftMostControlPoint = (o) => {
  let e = o[0],
    r = o[1],
    n = o[2],
...
P.PlotUtils.getRightMostControlPoint = (o) => {
  let e = o.length,
    r = o[e - 3],
    n = o[e - 2],
    g = o[e - 1],
...
P.PlotUtils.getBinomialFactor = (t, o) => {
  return (
...
P.PlotUtils.getQBSplinePoints = (t) => {
  if (t.length <= 2) return t;
  let o = 2,
    e = [],
    r = t.length - o - 1;
...
P.PlotUtils.getQuadricBSplineFactor = (t, o) => {
  return 0 == t
    ? Math.pow(o - 1, 2) / 2
    : 1 == t
