 ...
 */
const getCameraCentor = (viewer, type) => {
 ...
 */
const transformDegreeToDMS = (degree) => {
 ...
 * @returns 十进制度坐标值
 */
const transformDMSToDegree = (dms) => {
 ...
 * @returns
 */
const calculateOrientation = (cartesian, hpr) => {
