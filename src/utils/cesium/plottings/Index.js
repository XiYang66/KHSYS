...
class Plotting {
  ...
  DrawElliptic(options, callback) {
    this.initHandler();
    Creator.CreateElliptic(
      this.viewer,
      this.handler,
      this.resultObject.elliptic,
      options,
      callback
    );
  }
  ...
  DrawAssemble(options, callback) {
    this.initHandler();
    Creator.CreateAssemble(
      this.viewer,
      this.handler,
      this.resultObject.assemble,
      options,
      callback
    );
  }
  ...
  DrawSwallowtailArrow(options, callback) {
    this.initHandler();
    Creator.CreateSwallowtailArrow(
      this.viewer,
      this.handler,
  ...
  DrawStraightArrow(options, callback) {
    this.initHandler();
    Creator.CreateStraightArrow(
      this.viewer,
      this.handler,
      this.resultObject.straightArrow,
      options,
      callback
    );
  }
  ...
  DrawFormation(options, callback) {
    this.initHandler();
    Creator.CreateFormation(
      this.viewer,
      this.handler,
      this.resultObject.formation,
      options,
      callback
    );
  }
  ...
  DrawSector(options, callback) {
    this.initHandler();
    Creator.CreateSector(
      this.viewer,
      this.handler,
      this.resultObject.sector,
      options,
      callback
    );
  }
   ...
   * @param callback  回调函数
   */
  DrawGltf(options, callback) {
    this.initHandler();
    Creator.CreateGltf(
      this.viewer,
      this.handler,
      this.resultObject.gltf,
      options,
      callback
    );
  }
