        ...
        <div v-if="state.isBuilt" class="builtBox">
            ...
            <div class="builtInfo">
                ...
                <div class="linInfo">
                    ...
                    <div class="builtValue">
                        <el-select style="width: 190px !important;" v-model="state.pushData.date11"
                            placeholder="请选择目标类型" clearable>
                ...
                <div class="linInfo">
                    ...
                    <div class="builtValue">
                        <el-select style="width: 190px !important;" v-model="state.pushData.date8" placeholder="请选择目标类型"
                            clearable>
